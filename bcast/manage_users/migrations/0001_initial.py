    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.TextField(choices=[('individual', 'Individual'), ('intern', 'Intern'), ('nontech', 'NonTech'), ('employee', 'Employee'), ('manager', 'Manager'), ('owner', 'Owner'), ('agent', 'Agent')], default='individual')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enterprise_profiles', to='manage_organization.organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='manage_organization.organization')),
